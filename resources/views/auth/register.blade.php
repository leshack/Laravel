             ...
             <header class="text-4xl text-center font-semibold bg-gray-200 text-gray-700 py-5 px-6 sm:py-6 sm:px-8 sm:rounded-t-md">
                ...
                <form class="w-full px-6 space-y-6 sm:px-10 sm:space-y-8" method="POST"
                    ...
                    <div class="flex flex-wrap">
                        <label for="name" class="block text-gray-700 text-2xl font-bold mb-2 sm:mb-4">
                            {{ __('Name') }}:
                        </label>

                        <input id="name" type="text" class="text-2xl form-input w-full @error('name')  border-red-500 @enderror"
                    ...
                    <div class="flex flex-wrap">
                        <label for="phone" class="block text-gray-700 text-2xl font-bold mb-2 sm:mb-4">
                            {{ __('Mobile Number') }}:
                        </label>

                        <input id="phone" type="text" class="text-2xl form-input w-full @error('phone')  border-red-500 @enderror"
                    ...
                    <div class="flex flex-wrap">
                        <label for="password" class="block text-gray-700 text-2xl font-bold mb-2 sm:mb-4">
                            {{ __('Password') }}:
                        </label>
                    ...
                    <div class="flex flex-wrap">
                        <label for="password-confirm" class="block text-gray-700 text-2xl font-bold mb-2 sm:mb-4">
                            {{ __('Confirm Password') }}:
                        </label>

                        <input id="password-confirm" type="password" class="text-2xl form-input w-full"
